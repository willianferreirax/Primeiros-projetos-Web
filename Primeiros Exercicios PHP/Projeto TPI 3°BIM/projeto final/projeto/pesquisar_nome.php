...
<html>
	...
	<body class="body">
    	...
    	<div class="tela">
			...
			<div class="tela2">
				...
				<p style="font-size: 40px" class="expandir"> Pesquisa por nome</p>

				<form method="POST" action="?validar=true">

					<p>RM ou Matricula de professor:<input type="text" name="nome" class="input"></p>
					
				
					
					<p><input type="reset" value="Limpar" class="botao"> <input type="submit" name="pesquisar" value="Pesquisar" class="botao"></p>
	...
	if(isset($_REQUEST["validar"]) && $_REQUEST["validar"] == true){
		...
		$stmt = $conn->prepare("select * from aluno where rm = ?; select * from professor where matricula_do_professor = ?;");
	...
	echo "</table><br>";
	echo "<table>";
	$stmt = $conn->prepare("select * from professor where nome_do_professor = ?;");
	$stmt->bindParam(1, $_POST["nome"]);
	echo "<tr>
		...
		if($stmt->execute()){
			...
			echo "Falha na exibição dos professores";
		}
