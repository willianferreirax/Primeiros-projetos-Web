...
<html>
	...
	<body class="body">
    	...
    	<div class="tela">
			...
			<div class="tela2">		
				<p style="font-size: 40px"> Alterar dados do aluno </p>
				...
				<form method="POST" action="?validar=true">
					...
					<p>RM: <input type="text" name="id"></p>
					
					<input type="hidden" name="id" value="<?php echo $_REQUEST["id"]; ?>">
					
					<p><input type="reset" value="Limpar"> <input type="submit" name="cadastrar" value="Alterar"></p>
